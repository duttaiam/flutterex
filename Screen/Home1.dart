...
class Home extends StatelessWidget {
  ...
  List<FlutterExBottomNavigationBarModel> flutterExBottomNavigationBarItems =
    ...
    FlutterExBottomNavigationBarModel(icon: Icons.article, label: "Order"),
                            ...
                            itemBuilder: (context, position) {
                              return Padding(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(12.0),
                                  child: Image.network(
                                    "https://i.ibb.co/nwQ8rxQ/delicious-vietnamese-food-including-pho-ga-noodles-spring-rolls-white-table-181624-34062.jpg",
                                    height: 300,
                                    width: 200,
                                    fit: BoxFit.cover,
                                  ),
